...
{
    public partial class sidebar_NTV : System.Web.UI.UserControl
    {
        ...
        {
            var listCamnang = list_pro.Load_listprobytype(3, 0, 0, -1);
        ...
        private void Load_Banner()
        {
            try
            {
                var bannerPhai1 = per.Load_slider1(4, 1, -1);
                var bannerPhai2 = per.Load_slider1(5, 1, -1);
                var bannerPhai3 = per.Load_slider1(6, 1, -1);
                var bannerPhai4 = per.Load_slider1(7, 1, -1);
                var bannerPhai5 = per.Load_slider1(8, 1, -1);
                var bannerPhai6 = per.Load_slider1(9, 1, -1);
