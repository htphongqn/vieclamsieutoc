<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ungvientheonganhngheNTD.ascx.cs" Inherits="CatTrang.UIs.ungvientheonganhngheNTD" %>
...
<div class="page" id="recruitment"> 
    ...
    <div id="main">
      ...
      <!--End List jobs--> 
        <!--List jobs-->
        <div class="block">
          <div class="title_rec_home"><b>Hồ sơ ứng viên được nhiều người xem <asp:Literal ID="lbTitle" runat="server"></asp:Literal></b></div>
          <div class="block_rec bl_white">
            <ul id="list_most_viewed_jobs">
              <asp:Repeater ID="rptUngvien_XemNhieu" runat="server">
                    <ItemTemplate>
                        <li class="col_rec_item width50">
                            <div class="col_rec_item_ct"><a href="<%# GetLinkNTD(Eval("NEWS_ID")) %>" class="position_job">
                            <%# GetShortName(Eval("NEWS_TITLE"), 25)%></a>
        ...
        <div class="block"> 
          ...
          <div class="navBar">
            <div class="navBarLeft">
              <h2><span class="navBarTxt">Hồ sơ ứng viên <asp:Literal ID="lbTitle2" runat="server"></asp:Literal></span></h2>
            </div>
          ...
          <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>                
                ...
                <asp:TemplateColumn HeaderText="Tên ứng viên" HeaderStyle-Width="91%" ItemStyle-Wrap="False"
                ...
                <asp:TemplateColumn HeaderText="Tiêu đề hồ sơ" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                    HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False">
                    <ItemTemplate>                        
                        <div class="resumes_td align_l">
                            <div style="position: relative">
