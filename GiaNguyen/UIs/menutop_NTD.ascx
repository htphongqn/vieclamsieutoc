<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="menutop_NTD.ascx.cs" Inherits="CatTrang.UIs.menutop_NTD" %>

<div class="menu_rec">
    <ul>
    <li><a><em class=""><img src="../images/icon_home.png" /></em></a></li>
    <li><a href="/trang-chu.html">Cho người tìm việc</a></li>
    <li class="active"><a href="/nha-tuyen-dung.html">Cho nhà tuyển dụng</a>
