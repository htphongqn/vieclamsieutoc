<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NTV.Master" AutoEventWireup="true" CodeBehind="laylaimatkhauNTV.aspx.cs" Inherits="CatTrang.vi_vn.laylaimatkhauNTV" %>
          ...
          <div class="block_rec bl_white">
            <div class="tbUser_row">
              ...
              <div class="tbUser_col col_r">
                <input type="text" style="width:210px" id="txt_email_dang_nhap" runat="server" class="textbox" readonly="readonly" />
              </div>
            </div>
            <div class="tbUser_row">
            ...
            <div class="tbUser_row">
              ...
              <div class="tbUser_col col_r" style=" padding-top: 20px">
                <asp:Button ID="btnYeucau" runat="server" Text="Lấy lại mật khẩu" ValidationGroup="G40"
                      CssClass="btn_green02" onclick="btnYeucau_Click" />
