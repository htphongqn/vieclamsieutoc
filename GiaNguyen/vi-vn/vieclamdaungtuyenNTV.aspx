<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NTV.Master" AutoEventWireup="true" CodeBehind="vieclamdaungtuyenNTV.aspx.cs" Inherits="CatTrang.vi_vn.vieclamdaungtuyenNTV" %>
    ...
    <div id="main"> 
      ...
      <div class="block"> 
        ...
        <div class="resumes_status"> 
            <span class="resumes_status_item fr_status" style="width: 250px"> Bạn đã ứng tuyển <b><asp:Literal ID="lbCount" runat="server" Text="0"></asp:Literal></b> vị trí tuyển dụng</span>
            <span class="resumes_status_item">Tin còn hạn: <b><asp:Literal ID="lbCountConhan" runat="server" Text="0"></asp:Literal></b> tin</span> 
            <span class="resumes_status_item mr_l" style="display: block; margin-left: 25%">Tin hết hạn: <b><asp:Literal ID="lbCountHetnhan" runat="server" Text="0"></asp:Literal></b> tin</span>
        </div>
        ...
        <div class="btn_actions">  
            <asp:LinkButton ID="lnkHuyungtuyen" runat="server" CssClass="remove_profile" style="background-position: 0 -232px" OnClientClick="return confirm('Bạn chắc chắn hủy ứng tuyển tin đã chọn không?')" ToolTip="Hủy ứng tuyển danh sách việc làm đã ứng tuyển" Text="Hủy ứng tuyển" onclick="lnkHuyungtuyentin_Click"></asp:LinkButton>
          <div align="right" class="sort_by"><b>Sắp xếp theo: </b>
            <asp:DropDownList ID="ddlSort" runat="server" style="width:200px;" 
                ...
                <%--<asp:ListItem Value="1" Text="Thời gian ứng tuyển giảm dần"></asp:ListItem>
                <asp:ListItem Value="2" Text="Thời gian ứng tuyển tăng dần"></asp:ListItem>--%>
        ...
        <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>                
                ...
                <asp:TemplateColumn HeaderText="Thao tác">
                    ...
                    <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Center"></ItemStyle>
                    <ItemTemplate>
                        <a title="Click để xem thông tin chi tiết việc làm" target="_blank" href="/">Xem</a><br />
                        <asp:LinkButton ID="lnkHuyungtuyen" runat="server" OnClientClick="return confirm('Bạn chắc chắn hủy ứng tuyển không?')" CommandArgument='<%# Eval("NEWS_ID")%>' OnClick="lnkHuyungtuyen_Click" ToolTip="Hủy ứng tuyển" Text="Hủy ứng tuyển"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateColumn>
            </Columns>
        ...
        <!--Actions-->
        <div class="btn_actions"> 
         <asp:LinkButton ID="lnkHuyungtuyentin_2" runat="server" CssClass="remove_profile" style="background-position: 0 -232px" OnClientClick="return confirm('Bạn chắc chắn hủy ứng tuyển tin đã chọn không?')" ToolTip="Hủy ứng tuyển danh sách việc làm đã ứng tuyển" Text="Hủy ứng tuyển" onclick="lnkHuyungtuyentin_Click"></asp:LinkButton>
          <div align="right" class="sort_by"><b>Sắp xếp theo: </b>
