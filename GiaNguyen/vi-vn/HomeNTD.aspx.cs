...
{
    public partial class HomeNTD : System.Web.UI.Page
    {
        ...
        private void LoadUngvienMoi()
        {
            ...
            CollectionPager5.BindToControl = rptHoso_MoiNhat;
            rptHoso_MoiNhat.DataSource = CollectionPager5.DataSourcePaged;
            rptHoso_MoiNhat.DataBind();
            //}
        }
        private void Load_Banner()
        {
            try
            {
                var bannerGiua1 = per.Load_slider1(11, 1, -1);
                var bannerGiua2 = per.Load_slider1(12, 1, -1);
                var bannerGiua3 = per.Load_slider1(13, 1, -1);
