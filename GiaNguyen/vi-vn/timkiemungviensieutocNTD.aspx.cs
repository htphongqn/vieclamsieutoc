...
{
    public partial class timkiemungviensieutocNTD : System.Web.UI.Page
    {
        ...
        {
            var list2 = vlNews.GetEshopNewsBySearch(tieu_de, nganh_nghe, dia_diem, muc_luong, kinh_nghiem, 1);//1 tim viec, 2 tuyen dung
