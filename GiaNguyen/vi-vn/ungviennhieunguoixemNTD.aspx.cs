...
{
    public partial class ungviennhieunguoixemNTD : System.Web.UI.Page
    {
        ...
        private void Load_Ungvien()
        {
            ...
            //}
            var list2 = list_pro.Load_listprobytype(1, 0, 2, -1);//1 tim viec, 2 tuyen dung
        ...
        protected void lnkLuutin_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridItem item in GridItemList_Xemnhieu.Items)
            {
                ...
                if (check.Checked)
                {
                    ...
                    j++;
                    int newsId = Utils.CIntDef(GridItemList_Xemnhieu.DataKeys[i]);
