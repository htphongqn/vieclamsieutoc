<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NTD.Master" AutoEventWireup="true" CodeBehind="ungviennhieunguoixemNTD.aspx.cs" Inherits="CatTrang.vi_vn.ungviennhieunguoixemNTD" %>
        ...
        <div class="block"> 
          ...
          <div class="navBar">
            <div class="navBarLeft">
              <h2><span class="navBarTxt">Hồ sơ ứng viên được nhiều người xem</span></h2>
            </div>
            <div class="navBarRight">
                <div class="navigation_news">
                  <asp:Literal ID="litTopPager_Xemnhieu" runat="server"></asp:Literal>
                </div>
            </div>
            <div class="clear"></div>
          </div>
          <asp:DataGrid ID="GridItemList_Xemnhieu" CellPadding="0" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>                
                ...
                <asp:TemplateColumn HeaderText="Tên ứng viên" HeaderStyle-Width="91%"
                    ...
                    <ItemTemplate>
                        <asp:HiddenField ID="hddCusId" runat="server" Value='<%# Eval("CUSTOMER_ID")%>' />
                ...
                <asp:TemplateColumn HeaderText="Tiêu đề hồ sơ" HeaderStyle-Width="1%" 
                    HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False">
                    <ItemTemplate>
                        <%# GetShortName(Eval("NEWS_TITLE"), 25)%><br />
