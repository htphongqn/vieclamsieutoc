<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NTD.Master" AutoEventWireup="true" CodeBehind="timkiemungviensieutocNTD.aspx.cs" Inherits="CatTrang.vi_vn.timkiemungviensieutocNTD" %>
        ...
        <div class="block"> 
          ...
          <div class="navBar">
            <div class="navBarLeft">
              <h2><span class="navBarTxt">Hồ sơ ứng viên tìm thấy theo yêu cầu</span></h2>
            </div>
            <div class="navBarRight"> <!-- page number-->
              <div class="navigation_news">
              <asp:Literal ID="litTopPager_Timkiem" runat="server"></asp:Literal>
              </div>
              <!--End page number--></div>
            <div class="clear"></div>
          </div>          
          <asp:DataGrid ID="GridItemList" CellPadding="0" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>                
                <asp:TemplateColumn HeaderStyle-Width="1%" ItemStyle-Wrap="False" HeaderStyle-CssClass="tdGridHeader"
                 ...
                 <asp:TemplateColumn HeaderText="Tên ứng viên" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                    HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False">
                    <ItemTemplate>
                        <%# getTenCongty(DataBinder.Eval(Container.DataItem, "NEWS_ID"))%><br />
                        (<%# Eval("NEWS_COUNT")%>&nbsp;lượt xem)
                    </ItemTemplate>
                ...
                <asp:TemplateColumn HeaderText="Tiêu đề hồ sơ" HeaderStyle-Width="91%" ItemStyle-Wrap="False"
                    HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False"
                    SortExpression="NEWS_TITLE">
                    <ItemTemplate>                            
                            <div class="resumes_td align_l">
                            <div style="position: relative">
                                <a href="<%# GetLinkNTD(Eval("NEWS_ID")) %>" class="job_name"><%# GetShortName(Eval("NEWS_TITLE"), 20)%></a> 
                                <!-- tooltip element -->
                                ...
                                <table width="420" cellpadding="5" cellspacing="1" border="0" bgcolor="#d7d7d7">
                                  ...
                                  <tr>
                                    <td class="td_tootip" colspan="2">
                                      <b><span class="red" style="font-size: 12px">Kinh nghiệm:</span></b>
                ...
                <asp:TemplateColumn HeaderText="Kinh nghiệm" HeaderStyle-Width="1%" ItemStyle-Wrap="False"
                    HeaderStyle-CssClass="tdGridHeader" ItemStyle-CssClass="tdGridRow" HeaderStyle-Wrap="False">
                    <ItemTemplate>
                        <%# getKinhnghiem(DataBinder.Eval(Container.DataItem, "NEWS_ID"))%>                        
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%" HorizontalAlign="Left">
                    </HeaderStyle>
                    <ItemStyle Wrap="False" CssClass="tdGridRow" HorizontalAlign="Left"></ItemStyle>
                ...
                <asp:TemplateColumn HeaderText="Ngày làm mới" HeaderStyle-Width="91%" ItemStyle-Wrap="False"
                    ...
                    <ItemTemplate>
                        <%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "NEWS_UPDATEFRERESH")).ToString("dd-MM")%>
                    </ItemTemplate>
                    <HeaderStyle Wrap="False" CssClass="tdGridHeader" Width="1%"></HeaderStyle>
                    <ItemStyle Wrap="False" CssClass="tdGridRow"></ItemStyle>
                </asp:TemplateColumn>                        
          ...
          <div class=" marTB10 foolistjob">
            <%--<div class="fLeft marTB10 marL10"> 
                <a href="javascript:gui_mail_ban_be();" title="" class="guiBanBe">Lưu hồ sơ</a>
        ...
        <asp:Repeater ID="rptViecLam_MoiNhat" runat="server">
            <ItemTemplate>
                <li class="col_rec_item">
                    ...
                    <a href="<%# GetLinkNTD(Eval("NEWS_ID")) %>" class="position_job"><%# Eval("NEWS_TITLE")%></a>
