    ...
    <div id="main"> 
      ...
      <div class="block"> 
        ...
        <div class="btn_actions">
          <asp:LinkButton ID="lnkXoaTam" runat="server" CssClass="remove_profile" OnClientClick="return confirm('Bạn chắc chắn xóa tạm tin tuyển dụng đã chọn không?')" ToolTip="Xoá tạm các tin" Text="Xóa tạm tin" onclick="lnkXoaTam_Click"></asp:LinkButton> 
        <asp:LinkButton ID="lnkDangTin" runat="server" CssClass="post_profile" OnClientClick="return confirm('Bạn chắc chắn đăng tin tuyển dụng đã chọn không?')" ToolTip="Đăng các tin" Text="Đăng tin" onclick="lnkDangTin_Click"></asp:LinkButton> 
          <asp:LinkButton ID="lnkHuyDangTin" runat="server" CssClass="cancel_post_profile" 
                ToolTip="Huỷ đăng các tin" Text="Hủy đăng tin" onclick="lnkHuyDangTin_Click"></asp:LinkButton> 
          <asp:LinkButton ID="lnkPhucHoiXoaTam" runat="server" CssClass="recover_profile" 
                ToolTip="Khôi phục các tin xoá tạm" Text="Phục hồi tin xóa tạm" 
        ...
        <!--Actions-->
        <div class="btn_actions"> 
          <asp:LinkButton ID="lnkXoaTam_2" runat="server" CssClass="remove_profile" ToolTip="Xoá tạm các tin" Text="Xóa tạm tin"  OnClientClick="return confirm('Bạn chắc chắn xóa tạm tin tuyển dụng đã chọn không?')" onclick="lnkXoaTam_Click"></asp:LinkButton> 
        <asp:LinkButton ID="lnkDangTin_2" runat="server" CssClass="post_profile" ToolTip="Đăng các tin" Text="Đăng tin"  OnClientClick="return confirm('Bạn chắc chắn đăng tin tuyển dụng đã chọn không?')" onclick="lnkDangTin_Click"></asp:LinkButton> 
          <asp:LinkButton ID="lnkHuyDangTin_2" runat="server" CssClass="cancel_post_profile" ToolTip="Huỷ đăng các tin" Text="Hủy đăng tin" onclick="lnkHuyDangTin_Click"></asp:LinkButton> 
          <asp:LinkButton ID="lnkPhucHoiXoaTam_2" runat="server" CssClass="recover_profile" ToolTip="Khôi phục các tin xoá tạm" Text="Phục hồi tin xóa tạm" onclick="lnkPhucHoiXoaTam_Click"></asp:LinkButton>
          <div align="right" class="sort_by"><b>Sắp xếp theo: </b>
            <asp:DropDownList ID="ddlSort_2" runat="server" style="width:200px;" 
                  name="select_sap_xep_top" class="dropBox" AutoPostBack="True" 
                  onselectedindexchanged="ddlSort_2_SelectedIndexChanged">
                <asp:ListItem Value="1" Text="Thời gian cập nhật giảm dần"></asp:ListItem>
                <asp:ListItem Value="2" Text="Thời gian cập nhật tăng dần"></asp:ListItem>
                <asp:ListItem Value="3" Text="Thời gian làm mới giảm dần"></asp:ListItem>
                <asp:ListItem Value="4" Text="Thời gian làm mới tăng dần"></asp:ListItem>
