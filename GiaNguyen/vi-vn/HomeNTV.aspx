<%@ Page Title="" Language="C#" MasterPageFile="~/Master/NTV.Master" AutoEventWireup="true" CodeBehind="HomeNTV.aspx.cs" Inherits="CatTrang.vi_vn.HomeNTV" %>
...
<%@ Register src="~/UIs/BannerHomeNTV.ascx" tagname="BannerHomeNTV" tagprefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMain" runat="server">
    <div class="page" id="recruitment">
        <div id="main">
            <uc3:BannerHomeNTV ID="BannerHomeNTV1" runat="server" />
                    ...
                    <asp:Repeater ID="rptViecLam_Hot" runat="server">
                        <ItemTemplate>
                            <li class="col_rec_item">
                                <div class="col_rec_item_ct"><a href="<%# GetLink(Eval("NEWS_URL"),Eval("NEWS_SEO_URL"),Eval("CAT_SEO_URL")) %>" class="position_job"><%# Eval("NEWS_TITLE")%></a>
            ...
            <div class="block">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="CollectionPager5" />
                    </Triggers>
                    <ContentTemplate>
                <div class="block_rec bl_white">
