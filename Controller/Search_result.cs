...
namespace Controller
{
    public class Search_result
    {
        ...
        #endregion
        public List<Pro_details_entity> Load_search_result(string _txt,int lang)
        {
            ...
            var list = (from c in db.ESHOP_NEWS_CATs
                          ...
                          //&& a.NEWS_TYPE == type
                          select new { a.NEWS_ID, a.NEWS_TITLE, a.NEWS_IMAGE3, a.NEWS_IMAGE4, a.ADDRESS, a.PHONE, a.GOOPMAPSLINK, a.NEWS_PRICE1, a.NEWS_DESC, a.NEWS_SEO_URL, a.NEWS_URL, a.NEWS_ORDER, a.NEWS_ORDER_PERIOD, a.NEWS_PUBLISHDATE, b.CAT_SEO_URL }).Distinct().OrderByDescending(n => n.NEWS_ID).OrderByDescending(n => n.NEWS_ORDER);
        ...
        public List<Pro_details_entity> Load_search_resultAdv(int tour , int begin , int end, DateTime date,int lang)
        {
            List<Pro_details_entity> l = new List<Pro_details_entity>();
            var list = (from c in db.ESHOP_NEWS_CATs
                        join a in db.ESHOP_NEWs on c.NEWS_ID equals a.NEWS_ID
                        join b in db.ESHOP_CATEGORies on c.CAT_ID equals b.CAT_ID
                        where a.UNIT_ID1 == tour
                            && ((a.UNIT_ID2 == begin && a.UNIT_ID3 == end) || a.NEWS_UPDATE == date)
                            && b.CAT_LANGUAGE == lang
