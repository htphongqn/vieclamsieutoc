...
namespace Controller
{
    public class Propertity
    {
        ...
        public IQueryable<ESHOP_CATEGORy> Menu2(object catid)
        {
            ...
            var list = db.ESHOP_CATEGORies.Where(n => n.CAT_PARENT_ID == id && n.CAT_STATUS == 1).OrderByDescending(n => n.CAT_ORDER);
        ...
        public List<ESHOP_CATEGORy> MenuHotel(int position, int type, int limit, int rank, int lang)
        {
            try
            {
        ...
        public List<ESHOP_BANNER> Load_logo_and_sologan(int limit, int lang)
        {
            try
            {
                 var _logoSlogan = (from a in db.ESHOP_BANNERs
                                    where (a.BANNER_LANGUAGE == lang || lang == -1)
        ...
        public List<ESHOP_AD_ITEM> Load_slider1(int position, int limit, int lang)
        {
            try
            {
                var list = db.ESHOP_AD_ITEMs.Where(n => n.AD_ITEM_POSITION == position 
                    && (n.AD_ITEM_LANGUAGE == lang || lang == -1)).Take(limit).ToList();
                return list;
            }
            catch (Exception)
            {
        ...
        public string Getpath()
        {
            try
            {
                ...
                if (rausach.ToList().Count > 0)
                {
                    ...
                    if (str.Count() > 1)
                    {
                        string url = string.IsNullOrEmpty(Utils.CStrDef(rausach.ToList()[0].CAT_URL)) ? "/" + Utils.CStrDef(rausach.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach.ToList()[0].CAT_URL);
                        _result = Convert_Name(str) + "  &raquo;  <a href='" + url + "'>" + rausach.ToList()[0].CAT_NAME + "</a>";
                    }
                    else
                    {
                        ...
                        {
                            string url = string.IsNullOrEmpty(Utils.CStrDef(rausach.ToList()[0].CAT_URL)) ? "/" + Utils.CStrDef(rausach.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach.ToList()[0].CAT_URL);
                            _result = "  &raquo; <a href='" + url + "'>" + rausach.ToList()[0].CAT_NAME + "</a> ";
                        }
                        else
                        {
                            string url = string.IsNullOrEmpty(Utils.CStrDef(rausach.ToList()[0].CAT_URL)) ? "/" + Utils.CStrDef(rausach.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach.ToList()[0].CAT_URL);
                ...
                else
                {
                    ...
                    if (rausach1.ToList().Count > 0)
                    {
                        ...
                        if (str.Count() > 1)
                        {
                            string url = string.IsNullOrEmpty(Utils.CStrDef(rausach1.ToList()[0].CAT_URL)) ? "/" + Utils.CStrDef(rausach1.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach1.ToList()[0].CAT_URL);
                            _result = Convert_Name(str) + "  &raquo; <a href='" + url + "'>" + rausach1.ToList()[0].CAT_NAME + "</a>";
                        }
                        else
                        {
                            ...
                            {
                                string url = string.IsNullOrEmpty(Utils.CStrDef(rausach1.ToList()[0].CAT_URL)) ? "/" + Utils.CStrDef(rausach1.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach1.ToList()[0].CAT_URL);
                                _result = "  &raquo; <a href='" + url + "'>" + rausach1.ToList()[0].CAT_NAME + "</a> ";
                            }
                            else
                            {
                                string url = string.IsNullOrEmpty(Utils.CStrDef(rausach1.ToList()[0].CAT_URL)) ? "/" + Utils.CStrDef(rausach1.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach1.ToList()[0].CAT_URL);
        ...
        public string Convert_Name(string[] str)
        {
            ...
            try
            {
                ...
                for (int i = 1; i < str.Count(); i++)
                {
                    ...
                    //s += rausach.ToList()[0] + " > ";
                    string url = string.IsNullOrEmpty(Utils.CStrDef(rausach.ToList()[0].CAT_URL)) ? "/" + Utils.CStrDef(rausach.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach.ToList()[0].CAT_URL);
                    s += "  &raquo; <a href='" + url + "'>" + rausach.ToList()[0].CAT_NAME + "</a> ";
                }
                return s;
            }
            catch (Exception ex)
        ...
        public string GetpathEN()
        {
            try
            {
                ...
                if (rausach.ToList().Count > 0)
                {
                    ...
                    if (str.Count() > 1)
                    {
                        string url = string.IsNullOrEmpty(Utils.CStrDef(rausach.ToList()[0].CAT_URL)) ? "/en/" + Utils.CStrDef(rausach.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach.ToList()[0].CAT_URL);
                        _result = Convert_NameEN(str) + "  &raquo;  <a href='" + url + "'>" + rausach.ToList()[0].CAT_NAME + "</a>";
                    }
                    else
                    {
                        if (rausach.ToList()[0].CAT_SHOWITEM > 0)
                ...
                else
                {
                    ...
                    if (rausach1.ToList().Count > 0)
                    {
                        ...
                        if (str.Count() > 1)
                        {
                            string url = string.IsNullOrEmpty(Utils.CStrDef(rausach1.ToList()[0].CAT_URL)) ? "/en/" + Utils.CStrDef(rausach1.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach1.ToList()[0].CAT_URL);
                            _result = Convert_NameEN(str) + "  &raquo; <a href='" + url + "'>" + rausach1.ToList()[0].CAT_NAME + "</a>";
                        }
                        else
                        {
                            if (rausach1.ToList()[0].CAT_SHOWITEM > 0)
        ...
        public string GetpathRU()
        {
            try
            {
                ...
                if (rausach.ToList().Count > 0)
                {
                    ...
                    if (str.Count() > 1)
                    {
                        string url = string.IsNullOrEmpty(Utils.CStrDef(rausach.ToList()[0].CAT_URL)) ? "/ru/" + Utils.CStrDef(rausach.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach.ToList()[0].CAT_URL);
                        _result = Convert_NameRU(str) + "  &raquo;  <a href='" + url + "'>" + rausach.ToList()[0].CAT_NAME + "</a>";
                    }
                    else
                    {
                        if (rausach.ToList()[0].CAT_SHOWITEM > 0)
                ...
                else
                {
                    ...
                    if (rausach1.ToList().Count > 0)
                    {
                        ...
                        if (str.Count() > 1)
                        {
                            string url = string.IsNullOrEmpty(Utils.CStrDef(rausach1.ToList()[0].CAT_URL)) ? "/ru/" + Utils.CStrDef(rausach1.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach1.ToList()[0].CAT_URL);
                            _result = Convert_NameRU(str) + "  &raquo; <a href='" + url + "'>" + rausach1.ToList()[0].CAT_NAME + "</a>";
                        }
                        else
                        {
                            if (rausach1.ToList()[0].CAT_SHOWITEM > 0)
        ...
        public string Convert_NameRU(string[] str)
        {
            string s = "";
        ...
        public string GetpathCH()
        {
            try
            {
                ...
                if (rausach.ToList().Count > 0)
                {
                    ...
                    if (str.Count() > 1)
                    {
                        string url = string.IsNullOrEmpty(Utils.CStrDef(rausach.ToList()[0].CAT_URL)) ? "/ch/" + Utils.CStrDef(rausach.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach.ToList()[0].CAT_URL);
                        _result = Convert_NameCH(str) + "  &raquo;  <a href='" + url + "'>" + rausach.ToList()[0].CAT_NAME + "</a>";
                    }
                    else
                    {
                        if (rausach.ToList()[0].CAT_SHOWITEM > 0)
                ...
                else
                {
                    ...
                    if (rausach1.ToList().Count > 0)
                    {
                        ...
                        if (str.Count() > 1)
                        {
                            string url = string.IsNullOrEmpty(Utils.CStrDef(rausach1.ToList()[0].CAT_URL)) ? "/ch/" + Utils.CStrDef(rausach1.ToList()[0].CAT_SEO_URL) + ".html" : Utils.CStrDef(rausach1.ToList()[0].CAT_URL);
                            _result = Convert_NameCH(str) + "  &raquo; <a href='" + url + "'>" + rausach1.ToList()[0].CAT_NAME + "</a>";
                        }
                        else
                        {
                            if (rausach1.ToList()[0].CAT_SHOWITEM > 0)
        ...
        public string Convert_NameCH(string[] str)
        {
            string s = "";
