        ...
        public List<News_details_entity> Load_listnews(int _Catid)
        {
            try
            {
                ...
                var list = (from a in db.ESHOP_NEWS_CATs
                            ...
                            && b.NEWS_SHOWTYPE == 1
                            select new { b.NEWS_ID, b.NEWS_TITLE, b.NEWS_IMAGE3, b.NEWS_DESC, b.NEWS_SEO_URL, b.NEWS_URL, b.NEWS_ORDER, b.NEWS_ORDER_PERIOD, b.NEWS_PUBLISHDATE, c.CAT_SEO_URL, c.CAT_ORDER}).OrderByDescending(n => n.NEWS_PUBLISHDATE).OrderByDescending(n => n.CAT_ORDER).ToList();
